...
Open from node  | Load a model from a remote node reachable using [Kevoree WebSocket protocol](#kevoree-groups-websocket-protocol)| Ctrl+O
...
Kevoree Standard Libraries | Open the **Kevoree Standard Libraries** popup ([see below](#kevoree-standard-libraries)) | Alt+K
From custom repository     | Open the **From custom repository** popup ([see below](R#from-custom-repository))         | <none>
Custom push                | Open the **Custom push** popup ([see below](#custom-push))                               | <none>
...
Server settings | Open the **Server settings** popup ([see below](#server-settings)) | Ctrl+H
